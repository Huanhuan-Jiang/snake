...
TEST(SnakeTest, SnakeSize) {
  ...
  gamestatus::DequeOfUniquePairs<int, int> body9({{20, 30},
                                                  ...
                                                  {16, 27},
                                                  {15, 27}});
  gamestatus::Snake snake1(body1, gamestatus::Direction::RIGHT, 500, 500, 12345);
  gamestatus::Snake snake9(body9, gamestatus::Direction::RIGHT, 500, 500, 12345);
...
TEST(SnakeTest, GetDirection) {
  ...
  gamestatus::Snake snake9_right(body9, gamestatus::Direction::RIGHT, 500, 500, 12345);
  gamestatus::Snake snake9_left(body9, gamestatus::Direction::LEFT, 500, 500, 12345);
  gamestatus::Snake snake9_up(body9, gamestatus::Direction::UP, 500, 500, 12345);
  gamestatus::Snake snake9_down(body9, gamestatus::Direction::DOWN, 500, 500, 12345);
...
TEST(SnakeTest, MoveOneStep) {
  ...
  gamestatus::Snake snake_right_9(body9, gamestatus::Direction::RIGHT, 500,
                                  500, 12345);
  gamestatus::Snake snake_up_9(body9, gamestatus::Direction::UP, 500, 500, 12345);
  gamestatus::Snake snake_down_9(body9, gamestatus::Direction::DOWN, 500, 500, 12345);

  gamestatus::Snake snake_left_7(body7, gamestatus::Direction::LEFT, 500, 500, 12345);
...
TEST(SnakeTest, MoveOneStepThenHitWall) {
  ...
  gamestatus::Snake snake_up(body_up, gamestatus::Direction::UP, 500, 500, 12345);
...
TEST(UpdateTest, NextDirection) {
  ...
  gamestatus::Snake snake(initial_body, gamestatus::Direction::RIGHT, 500, 500, 12345);
